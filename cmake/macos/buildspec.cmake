...
function(_check_dependencies_macos)
  ...
  set(openssl_filename "openssl-macos-VERSION-ARCH-REVISION.tar.gz")
  set(openssl_destination "openssl-macos-VERSION-ARCH")
  set(obs-studio_filename "VERSION.tar.gz")
  set(obs-studio_destination "obs-studio-VERSION")
  set(dependencies_list prebuilt qt6 openssl obs-studio)
