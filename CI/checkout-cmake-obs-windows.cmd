...
if not exist %OBSPath%\build64\libobs\%build_config%\obs.lib (
	echo obs-studio\build64\libobs\%build_config%\obs.lib does not exist
	set BuildOBS=true
)
if not exist %OBSPath%\build64\UI\obs-frontend-api\%build_config%\obs-frontend-api.lib (
	echo obs-studio\build64\UI\obs-frontend-api\%build_config%\obs-frontend-api.lib does not exist
	set BuildOBS=true
)
