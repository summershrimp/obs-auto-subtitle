...
enum AudioConfig_AudioEncoding : int {
  ...
  AudioConfig_AudioEncoding_AAC = 2,
  AudioConfig_AudioEncoding_MPEG2 = 3,
...
constexpr AudioConfig_AudioEncoding AudioConfig_AudioEncoding_AudioEncoding_MAX = AudioConfig_AudioEncoding_MPEG2;
...
class AudioConfig final :
 ...
 public:
  ...
  static constexpr AudioEncoding AAC =
    AudioConfig_AudioEncoding_AAC;
  static constexpr AudioEncoding MPEG2 =
    AudioConfig_AudioEncoding_MPEG2;
